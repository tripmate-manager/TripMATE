...
public class FileUploadUtil {
    ...
    public boolean fileExtensionValidCheck(MultipartFile file) throws FileUploadException{
    ...
    public ReviewImageDTO fileUpload(List<String> saveFiles, MultipartFile file) throws FileUploadException {
    ...
    public void deleteFile(List<String> saveFiles) {
