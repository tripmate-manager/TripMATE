...
public class PlanApiServiceImpl implements PlanApiService {
    ...
    @Override
    public boolean updatePlanViews(String planNo) throws Exception {
        Call<ResponseWrapper<Boolean>> data = RetrofitClient.getApiService(PlanService.class).updatePlanViews(planNo);
        boolean result;
