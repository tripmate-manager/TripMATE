    ...
    <% if (reviewList != null) {
        ...
        <div class="reviewlist_list_wrap">
            ...
            <div class="reviewlist_item_title_wrap">
                <div class="reviewlist_item_ninkname"><%=reviewVO.getNickName()%></div>
                <div class="reviewlist_item_avg_score"><%=reviewVO.getReviewAverageScore()%></div>
                ...
                <details class="flag">
                    ...
                    <div class="report">
                        ...
                        <p class="review_menu_delete" onclick='deleteReview("<%=reviewVO.getReviewNo()%>", "<%=reviewVO.getDailyPlanNo()%>")'>삭제하기</p>
                    </div>
                </details>
                <% } %>
            </div>
            ...
            <div class="reviewlist_item_img_wrap">
                <img class="reviewlist_item_img" src="/review/display.trip?filename=<%=reviewVO.getReviewImageList().get(0).getReviewImageName()%>"/>
            </div>
            <% } %>
            <p class="reviewlist_item_contents"><%=reviewVO.getReviewContents()%></p>
            ...
            <div class="reviewlist_item_score_wrap" id="review_score_location_wrap" style="display: none">
                ...
                <span class="star">★★★★★
                    ...
                    <input type="range" class="star_score_range" id="star_score_location" value="5" step="1" min="0" max="10">
                </span>
            </div>
            <div class="reviewlist_item_score_wrap" id="review_score_amount_wrap" style="display: none">
                ...
                <span class="star">★★★★★
                    ...
                    <input type="range" class="star_score_range" id="star_score_amount" value="5" step="1" min="0" max="10">
                </span>
            </div>
            <div class="reviewlist_item_score_wrap" id="review_score_all_wrap" style="display: none">
                ...
                <span class="star">★★★★★
                    ...
                    <input type="range" class="star_score_range" id="star_score_all" value="5" step="1" min="0" max="10">
                </span>
            </div>
            <div class="reviewlist_item_score_wrap" id="review_score_facility_wrap" style="display: none">
                ...
                <span class="star">★★★★★
                    ...
                    <input type="range" class="star_score_range" id="star_score_facility" value="<%=reviewVO.getScoreFacility()%>" step="1" min="0" max="10">
                </span>
            </div>
            <div class="reviewlist_item_score_wrap" id="review_score_sanitary_wrap" style="display: none">
                ...
                <span class="star">★★★★★
                    ...
                    <input type="range" class="star_score_range" id="star_score_sanitary" value="5" step="1" min="0" max="10">
                </span>
            </div>
            <div class="reviewlist_item_score_wrap" id="review_score_service_wrap" style="display: none">
                ...
                <span class="star">★★★★★
                    ...
                    <input type="range" class="star_score_range" id="star_score_service" value="5" step="1" min="0" max="10">
                </span>
            </div>
            <div class="reviewlist_item_score_wrap" id="review_score_food_wrap" style="display: none">
                ...
                <span class="star">★★★★★
                    ...
                    <input type="range" class="star_score_range" id="star_score_food" value="5" step="1" min="0" max="10">
                </span>
            </div>
        </div>
    </div>
